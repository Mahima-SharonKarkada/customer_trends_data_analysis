...
- **Feature Engineering:**
  - `age_group` — binned customer ages into segments (Young Adult, Adult, Middle-aged, Senior)
...
- How to clean and prepare real-world messy data using **pandas** (handling nulls, renaming columns, feature engineering)
- Writing **SQL queries** for actual business questions — segmentation, ranking, aggregations, and window functions
- How to connect **Python to PostgreSQL** and load DataFrames directly into a database
- Building an **interactive Power BI dashboard** with slicers, KPI cards, and multiple chart types
- Thinking like a **data analyst** by translating raw data into business recommendations
